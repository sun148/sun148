...
String url = "http://192.168.0.108:8088/ProjectOne/ESP2022/esp8266/nodemcu/nodemcu/esp8266mysql/add.php?temp="+String(myTemperature)+"&"+"hum="+String(myHumidity);
...
delay(60000); // <============== change Delay function for rate of data to your Mysql server throughput
}
